...
const DRAGON_TILES = ["5z", "6z", "7z"] as const;

const DRAGON_YAKU_NAMES: Record<(typeof DRAGON_TILES)[number], string> = {
  "5z": "役牌 白",
  "6z": "役牌 发",
  "7z": "役牌 中"
};
...
function detectYakuman(
  ...
  if (division.pattern === "standard") {
    ...
    else if (windTriplets.length === 3 && windPair !== undefined) add("shousuushi", "小四喜");
